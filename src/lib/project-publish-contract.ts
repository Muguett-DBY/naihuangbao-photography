import type { LegacyWorkspaceProject, WorkspaceProject } from "../types/workspace-project";
...
export function validatePublishedProjectDraft(value: unknown): value is PublishedProjectDraft {
  ...
  const project = draft.project as Partial<WorkspaceProject | LegacyWorkspaceProject> | undefined;
