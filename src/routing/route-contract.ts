...
export const routeContract = [
  { path: "/", scope: "primary" },
  { path: "/archive", scope: "practice" },
  { path: "/archive/:id", scope: "practice", dynamic: true, staticShell: true },
  { path: "/vault", scope: "practice" },
  { path: "/stories", scope: "practice" },
  { path: "/stories/:id", scope: "practice", dynamic: true, staticShell: true },
  { path: "/create", scope: "practice" },
  { path: "/compose", scope: "practice" },
  { path: "/curate", scope: "practice" },
  { path: "/create/story", scope: "practice" },
  { path: "/studio", scope: "practice" },
  { path: "/projects", scope: "practice" },
  { path: "/share/:slug", scope: "practice", dynamic: true },
  { path: "/about", scope: "primary" },
  { path: "/editor", scope: "practice" },
  { path: "/practice", scope: "practice" },
  { path: "/lab", scope: "practice", edgeRedirect: "/practice" },
  { path: "/gallery", scope: "primary" },
  { path: "/gallery/:id", scope: "primary", dynamic: true },
  ...
  { path: "/booking", scope: "primary" },
  { path: "/map", scope: "primary" },
  { path: "/login", scope: "primary" },
  { path: "/dashboard", scope: "primary" },
