...
export const routeLoaders = {
  ...
  "/vault": () => import("../pages/AssetVaultPage").then((module) => asDefault(module.AssetVaultPage)),
  ...
  "/compose": () => import("../pages/SceneComposerPage").then((module) => asDefault(module.SceneComposerPage)),
  "/curate": () => import("../pages/CreativeCuratorPage").then((module) => asDefault(module.CreativeCuratorPage)),
