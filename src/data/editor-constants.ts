...
export const TOOLS: Record<BeautyCategory, ToolDef[]> = {
  ...
  tools: [
    { key: "blur_bg", icon: "🌫", labelKey: "editor.blurBg" },
    { key: "bg_remove", icon: "✂", labelKey: "editor.bgRemove" },
    { key: "bg_solid", icon: "🟦", labelKey: "editor.bgSolid" },
    { key: "bg_gradient", icon: "🌈", labelKey: "editor.bgGradient" },
    { key: "local_bright", icon: "🔆", labelKey: "editor.localBright" },
    { key: "local_warm", icon: "🔥", labelKey: "editor.localWarm" },
    { key: "local_sat", icon: "💧", labelKey: "editor.localSat" },
    { key: "color_splash", icon: "🎯", labelKey: "editor.colorSplash" },
    { key: "double_exposure", icon: "🔄", labelKey: "editor.doubleExposure" },
  ],
  bg: [
    { key: "blur_bg", icon: "🌫", labelKey: "editor.blurBg" },
    { key: "bg_remove", icon: "✂", labelKey: "editor.bgRemove" },
