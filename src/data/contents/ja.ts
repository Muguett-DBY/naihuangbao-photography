...
export const defaultSiteContent: SiteContent = {
  siteConfig: {
    ...
    tagline: "個人ビジュアルアーカイブとローカル制作ツール",
    description: "写真、インタラクティブな物語、ブラウザグラフィックス、ローカル優先の制作ツールを探る個人練習プロジェクト。",
    contactStatus: "個人練習プロジェクト",
    contactHint: "ブラウザで動くビジュアル実験、制作ノート、創作ツールを探索できます。",
