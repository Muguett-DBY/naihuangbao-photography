...
export const defaultSiteContent: SiteContent = {
  siteConfig: {
    ...
    tagline: "Nanjing portrait and couple photography",
    description: "A Nanjing-based personal photographer for women, couples, and relaxed city portraits, with style planning and full posing guidance.",
    contactStatus: "Nanjing sessions open",
    contactHint: "Browse the portfolio and packages, then request a date online or chat about your ideas on Xiaohongshu.",
