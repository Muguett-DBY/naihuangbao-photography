...
export const defaultSiteContent: SiteContent = {
  siteConfig: {
    ...
    tagline: "Personal visual archive and local creative tools",
    description: "A living personal practice project exploring photography, interactive storytelling, browser graphics, and local-first creative tools.",
    contactStatus: "Personal practice project",
    contactHint: "Explore visual experiments, process notes, and creative tools that run in the browser.",
