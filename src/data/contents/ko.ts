...
export const defaultSiteContent: SiteContent = {
  siteConfig: {
    ...
    tagline: "개인 비주얼 아카이브와 로컬 창작 도구",
    description: "사진, 인터랙티브 스토리텔링, 브라우저 그래픽과 로컬 우선 창작 도구를 탐구하는 개인 연습 프로젝트입니다.",
    contactStatus: "개인 연습 프로젝트",
    contactHint: "브라우저에서 실행되는 비주얼 실험, 과정 노트와 창작 도구를 살펴보세요.",
