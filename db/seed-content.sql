...
('course-004', '摆姿引导：让模特自然放松', 'Posing Guide: Making Models Feel Natural', '站姿、坐姿、互动引导的完整方法论，让被拍者放松自然。', 'Complete methodology for standing, sitting, and interaction posing.', '/icons/user.svg', 'posing', 'beginner', 40, 4, 1, datetime('now'), datetime('now')),
('course-005', '进阶：夜景与弱光人像', 'Advanced: Night & Low-Light Portraits', '高感光度运用、补光技巧、长曝光人像，突破弱光环境限制。', 'High ISO usage, fill light techniques, long exposure portraits.', '/icons/moon.svg', 'advanced', 'advanced', 55, 5, 1, datetime('now'), datetime('now')),
...
('preset-004', '电影感视频 LUT 包', 'Cinematic Video LUT Pack', '6 个电影感 LUT，适合 Vlog、短视频、婚礼视频调色。', '6 cinematic LUTs for vlogs, short films, and wedding videos.', 'luts', '["/icons/video.svg"]', '/downloads/preset-cinematic-lut.zip', '¥19', 0, 42, datetime('now'), datetime('now')),
('preset-005', '高清人像笔刷套装', 'HD Portrait Brush Set', '20 个精修笔刷，包含磨皮、光影、纹理等类型。', '20 retouching brushes including skin, light, and texture types.', 'photoshop', '["/icons/brush.svg"]', '/downloads/preset-brushes.zip', '¥15', 0, 35, datetime('now'), datetime('now')),
('preset-006', '证件照/形象照 LR 预设', 'ID Photo Lightroom Presets', '8 个快速出片预设，专为证件照、形象照、简历照片设计。', '8 quick presets designed for ID photos, profile pictures, and resume photos.', 'lightroom', '["/icons/id.svg"]', '/downloads/preset-id-photo.zip', '¥19', 0, 53, datetime('now'), datetime('now')),
('preset-007', '日系清新 LR 预设', 'Japanese Fresh Lightroom Presets', '12 个明亮通透的日系预设，适合樱花、校园、清新风格拍摄。', '12 bright and transparent Japanese presets for cherry blossom and campus shoots.', 'lightroom', '["/icons/flower.svg"]', '/downloads/preset-japanese-fresh.zip', '¥29', 1, 97, datetime('now'), datetime('now')),
...
('merch-004', '品牌 T 恤', 'Brand T-Shirt', '摄影师联名款 T 恤，简约设计，纯棉材质。', 'Photographer collaboration T-shirt, minimalist design, 100% cotton.', '["/icons/shirt.svg"]', 'other', '¥89', 1, datetime('now'), datetime('now')),
('merch-005', '品牌帆布包', 'Brand Canvas Bag', '摄影主题设计帆布包，大容量，日常通勤实用。', 'Photography-themed canvas bag, large capacity, practical for daily use.', '["/icons/shopping-bag.svg"]', 'other', '¥59', 1, datetime('now'), datetime('now')),
('merch-006', '器材租赁：索尼 A7C II', 'Equipment Rental: Sony A7C II', '含机身 + 适马 28-70mm 镜头，适合体验高端器材。需提前预约。', 'Camera body + Sigma 28-70mm lens. Reservation required.', '["/icons/camera.svg"]', 'other', '¥99/天', 1, datetime('now'), datetime('now')),
('merch-007', '单张精修', 'Single Photo Retouch', '基础磨皮 + 调色，适合日常写真照片精修。', 'Basic skin smoothing + color grading for everyday portrait photos.', '["/icons/brush.svg"]', 'other', '¥19/张', 1, datetime('now'), datetime('now')),
('merch-008', '深度精修', 'Deep Photo Retouch', '精细磨皮 + 液化 + 调色，适合商业级人像作品。', 'Detailed skin smoothing + liquify + color grading for commercial portraits.', '["/icons/star.svg"]', 'other', '¥39/张', 1, datetime('now'), datetime('now')),
('merch-009', '证件照精修', 'ID Photo Retouch', '证件照/形象照专用精修，快速出片，符合证件要求。', 'Specialized retouching for ID and profile photos.', '["/icons/id.svg"]', 'other', '¥29/张', 1, datetime('now'), datetime('now')),
('merch-010', '批量调色（10张起）', 'Batch Color Grading (10+)', '统一风格调色，适合写真套图、活动照片批量处理。', 'Unified style color grading for portrait sets and event photos.', '["/icons/rainbow.svg"]', 'other', '¥10/张', 1, datetime('now'), datetime('now'));
